...
if not st.session_state.user:
        ...
        with tab1:
            ...
            if st.button("로그인"):
                ...
                if any(u["username"] == username and u["password"] == hashed for u in users):
                    ...
                    cookies.set('username', username) # ⬅️ 로그인 성공 시 쿠키 저장
    ...
    with col2:
        if st.button("로그아웃"):
            ...
            cookies.delete('username') # ⬅️ 로그아웃 시 쿠키 삭제
            st.rerun()
    ...
    with tab_data:
        ...
        if st.button("👥 계정 삭제"):
            ...
            cookies.delete('username')      # ⬅️ 계정 삭제 시 쿠키 삭제
